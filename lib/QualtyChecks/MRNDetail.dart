  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        SizedBox(
          width: 120,
          child: Text(label, style: MRNConstants.headerStyle),
        ),
        Expanded(
          child: Text(value, style: MRNConstants.valueStyle),
        ),
      ],
    );
  }
...
class QualityParametersGrid extends StatelessWidget {
  ...
  List<PlutoColumn> _buildColumns() {
    return [
      PlutoColumn(
        title: MRNConstants.gridColumns[0],
        field: 'QualityParameter',
        type: PlutoColumnType.text(),
        enableEditingMode: false,
      ),
      PlutoColumn(
        title: MRNConstants.gridColumns[1],
        field: 'StdRange',
        type: PlutoColumnType.text(),
        enableEditingMode: false,
      ),
      PlutoColumn(
        title: MRNConstants.gridColumns[2],
        field: 'StdOptions',
        type: PlutoColumnType.text(),
        enableEditingMode: false,
      ),
      PlutoColumn(
        title: MRNConstants.gridColumns[3],
        field: 'ObservedValue',
        type: PlutoColumnType.text(),
