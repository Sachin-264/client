  ...
  MRNReportBloc() : super(MRNReportInitial()) {
    on<FetchMRNReport>((event, emit) async {
      ...
      try {
        ...
        final url = Uri.parse(
            'http://localhost/AquavivaAPI/get_mrn_qc_details.php?BranchCode=${event.branchCode}&FromDate=${event.fromDate}&ToDate=${event.toDate}&Level1=&UserCode=0&Company_QC_SingleLevel=&Branch_QC_Level=0&Pending= ${event.pending}');
